...
public class Item
{
    ...
    public Item(int idex, string name, ItemType type)       //아이템을 생성하는 생성자 함수
    {
        this.idex = idex;                                   //각 변수들을 함수로 받아서 생성
        this.name = name;
        this.type = type;
    }
}
...
public class ExGameSystem : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Item shield = new Item(0, "Shield", ItemType.Armor);     //아이템 예시 방패 생성
